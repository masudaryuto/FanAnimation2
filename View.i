...
# 1 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.1.6/include/stdint.h" 1 3 4
# 52 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.1.6/include/stdint.h" 3 4
...
# 53 "/Applications/Xcode.app/Contents/Developer/Toolchains/XcodeDefault.xctoolchain/usr/lib/clang/13.1.6/include/stdint.h" 2 3 4
...
# 3 "./Definition.h" 2
# 1 "/usr/local/include/handy.h" 1
# 54 "/usr/local/include/handy.h"
enum {
...
# 85 "/usr/local/include/handy.h"
enum {
    HG_ColorDraw, HG_ColorFill, HG_CompositeMode
};
# 97 "/usr/local/include/handy.h"
typedef int hgfont;
# 153 "/usr/local/include/handy.h"
typedef struct {
    int width;
    int height;
    char hasalpha;
...
static inline __attribute__((always_inline)) hgcolor HgColorCode(unsigned int hex) { return (hgcolor)hex; }
# 313 "/usr/local/include/handy.h"
...
static int HgEncoding(int coding)
__attribute__((deprecated("Only UTF-8 is available")));
static inline __attribute__((always_inline)) int HgEncoding(int coding) {
    return (0);
}
# 4 "./Definition.h" 2
